...
## **How to get started:**
Copy the files in your program folder , add the header in your main and compile the .c file with your main. This function can be enhanced by setting a buffer of your choice adding a value to the MACRO BUFFER_SIZE while you compile it.
<br>Example:
```
